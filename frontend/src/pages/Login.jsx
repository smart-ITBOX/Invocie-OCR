  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2" data-testid="login-page">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.pexels.com/photos/6969316/pexels-photo-6969316.jpeg)",
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-white/90 text-xl font-public">
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <Card className="border-[#0B2B5C]/10 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-2xl font-manrope text-[#0B2B5C]">
                    Welcome Back
                  </CardTitle>
                  <CardDescription>
            ...
            <TabsContent value="register">
              <Card className="border-[#0B2B5C]/10 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Register to start processing invoices
                  </CardDescription>
                </CardHeader>
                <CardContent>
